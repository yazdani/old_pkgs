...
protected:
  ...
  actionlib::SimpleActionServer<hector_quadrotor_msgs::followerAction> action_; 
  std::string action_name_;
  // create messages that are used to published feedback/result
  hector_quadrotor_msgs::followerFeedback feedback_;
  hector_quadrotor_msgs::followerResult result_;
